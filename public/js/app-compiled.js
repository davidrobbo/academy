...
/******/return __webpack_require__(__webpack_require__.s=118);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports){/*
...
if(typeof item[0]!=="number"||!alreadyImportedModules[item[0]]){if(mediaQuery&&!item[2]){item[2]=mediaQuery;}else if(mediaQuery){item[2]="("+item[2]+") and ("+mediaQuery+")";}list.push(item);}}};return list;};/***/},/* 1 *//***/function(module,exports){module.exports=function normalizeComponent(rawScriptExports,compiledTemplate,scopeId,cssModules){var esModule;var scriptExports=rawScriptExports=rawScriptExports||{};// ES6 modules interop
...
if(cssModules){var computed=options.computed||(options.computed={});Object.keys(cssModules).forEach(function(key){var module=cssModules[key];computed[key]=function(){return module;};});}return{esModule:esModule,exports:scriptExports,options:options};};/***/},/* 2 *//***/function(module,exports,__webpack_require__){/*
  MIT License http://www.opensource.org/licenses/mit-license.php
  Author Tobias Koppers @sokra
  Modified by Evan You @yyx990803
*/var hasDocument=typeof document!=='undefined';if(typeof DEBUG!=='undefined'&&DEBUG){if(!hasDocument){throw new Error('vue-style-loader cannot be used in a non-browser environment. '+"Use { target: 'node' } in your Webpack config to indicate a server-rendering environment.");}}var listToStyles=__webpack_require__(116);/*
type StyleObject = {
  id: number;
...
if(utils.isStandardBrowserEnv()){var cookies=__webpack_require__(29);// Add xsrf header
...
request.send(requestData);});};/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(4));/***/},/* 7 *//***/function(module,exports,__webpack_require__){"use strict";/**
 * A `Cancel` is an object that is thrown when an operation is canceled.
 *
 * @class
 * @param {string=} message The message.
 */function Cancel(message){this.message=message;}Cancel.prototype.toString=function toString(){return'Cancel'+(this.message?': '+this.message:'');};Cancel.prototype.__CANCEL__=true;module.exports=Cancel;/***/},/* 8 *//***/function(module,exports,__webpack_require__){"use strict";module.exports=function isCancel(value){return!!(value&&value.__CANCEL__);};/***/},/* 9 *//***/function(module,exports,__webpack_require__){"use strict";var enhanceError=__webpack_require__(23);/**
 ...
 */module.exports=function createError(message,config,code,response){var error=new Error(message);return enhanceError(error,config,code,response);};/***/},/* 10 *//***/function(module,exports,__webpack_require__){"use strict";module.exports=function bind(fn,thisArg){return function wrap(){var args=new Array(arguments.length);for(var i=0;i<args.length;i++){args[i]=arguments[i];}return fn.apply(thisArg,args);};};/***/},/* 11 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_vue__=__webpack_require__(13);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);var event=new __WEBPACK_IMPORTED_MODULE_0_vue___default.a();/* unused harmony default export */var _unused_webpack_default_export=event;/***/},/* 12 *//***/function(module,exports,__webpack_require__){"use strict";/* WEBPACK VAR INJECTION */(function(process){/**
  * vue-router v2.2.1
  * (c) 2017 Evan You
  * @license MIT
  *//*  */function assert(condition,message){if(!condition){throw new Error("[vue-router] "+message);}}function warn(condition,message){if(!condition){typeof console!=='undefined'&&console.warn("[vue-router] "+message);}}var View={name:'router-view',functional:true,props:{name:{type:String,default:'default'}},render:function render(h,ref){var props=ref.props;var children=ref.children;var parent=ref.parent;var data=ref.data;data.routerView=true;var name=props.name;var route=parent.$route;var cache=parent._routerViewCache||(parent._routerViewCache={});// determine current view depth, also check to see if the tree
// has been toggled inactive but kept-alive.
var depth=0;var inactive=false;while(parent){if(parent.$vnode&&parent.$vnode.data.routerView){depth++;}if(parent._inactive){inactive=true;}parent=parent.$parent;}data.routerViewDepth=depth;// render previous view if the tree is inactive and kept-alive
if(inactive){return h(cache[name],data,children);}var matched=route.matched[depth];// render empty node if no matched route
if(!matched){cache[name]=null;return h();}var component=cache[name]=matched.components[name];// inject instance registration hooks
var hooks=data.hook||(data.hook={});hooks.init=function(vnode){matched.instances[name]=vnode.child;};hooks.prepatch=function(oldVnode,vnode){matched.instances[name]=vnode.child;};hooks.destroy=function(vnode){if(matched.instances[name]===vnode.child){matched.instances[name]=undefined;}};// resolve props
...
if(e.metaKey||e.ctrlKey||e.shiftKey){return;}// don't redirect when preventDefault called
...
if(stack[0]!==''){stack.unshift('');}return stack.join('/');}function parsePath(path){var hash='';var query='';var hashIndex=path.indexOf('#');if(hashIndex>=0){hash=path.slice(hashIndex);path=path.slice(0,hashIndex);}var queryIndex=path.indexOf('?');if(queryIndex>=0){query=path.slice(queryIndex+1);path=path.slice(0,queryIndex);}return{path:path,query:query,hash:hash};}function cleanPath(path){return path.replace(/\/\//g,'/');}/*  */function createRouteMap(routes,oldPathMap,oldNameMap){var pathMap=oldPathMap||Object.create(null);var nameMap=oldNameMap||Object.create(null);routes.forEach(function(route){addRouteRecord(pathMap,nameMap,route);});return{pathMap:pathMap,nameMap:nameMap};}function addRouteRecord(pathMap,nameMap,route,parent,matchAs){var path=route.path;var name=route.name;if(process.env.NODE_ENV!=='production'){assert(path!=null,"\"path\" is required in a route configuration.");assert(typeof route.component!=='string',"route config \"component\" for path: "+String(path||name)+" cannot be a "+"string id. Use an actual component instead.");}var record={path:normalizePath(path,parent),components:route.components||{default:route.component},instances:{},name:name,parent:parent,matchAs:matchAs,redirect:route.redirect,beforeEnter:route.beforeEnter,meta:route.meta||{},props:route.props==null?{}:route.components?route.props:{default:route.props}};if(route.children){// Warn if route is named and has a default child route.
// If users navigate to this route by name, the default child will
// not be rendered (GH Issue #629)
if(process.env.NODE_ENV!=='production'){if(route.name&&route.children.some(function(child){return /^\/?$/.test(child.path);})){warn(false,"Named Route '"+route.name+"' has a default child route. "+"When navigating to this named route (:to=\"{name: '"+route.name+"'\"), "+"the default child route will not be rendered. Remove the name from "+"this route and use the name of the default child route for named "+"links instead.");}}route.children.forEach(function(child){var childMatchAs=matchAs?cleanPath(matchAs+"/"+child.path):undefined;addRouteRecord(pathMap,nameMap,child,record,childMatchAs);});}if(route.alias!==undefined){if(Array.isArray(route.alias)){route.alias.forEach(function(alias){var aliasRoute={path:alias,children:route.children};addRouteRecord(pathMap,nameMap,aliasRoute,parent,record.path);});}else{var aliasRoute={path:route.alias,children:route.children};addRouteRecord(pathMap,nameMap,aliasRoute,parent,record.path);}}if(!pathMap[record.path]){pathMap[record.path]=record;}if(name){if(!nameMap[name]){nameMap[name]=record;}else if(process.env.NODE_ENV!=='production'&&!matchAs){warn(false,"Duplicate named routes definition: "+"{ name: \""+name+"\", path: \""+record.path+"\" }");}}}function normalizePath(path,parent){path=path.replace(/\/$/,'');if(path[0]==='/'){return path;}if(parent==null){return path;}return cleanPath(parent.path+"/"+path);}var index$1=Array.isArray||function(arr){return Object.prototype.toString.call(arr)=='[object Array]';};var isarray=index$1;/**
 * Expose `pathToRegexp`.
...
return match({_normalized:true,path:resolvedPath,query:query,hash:hash},undefined,location);}else{warn(false,"invalid redirect option: "+JSON.stringify(redirect));return _createRoute(null,location);}}function alias(record,location,matchAs){var aliasedPath=fillParams(matchAs,location.params,"aliased route with path \""+matchAs+"\"");var aliasedMatch=match({_normalized:true,path:aliasedPath});if(aliasedMatch){var matched=aliasedMatch.matched;var aliasedRecord=matched[matched.length-1];location.params=aliasedMatch.params;return _createRoute(aliasedRecord,location);}return _createRoute(null,location);}function _createRoute(record,location,redirectedFrom){if(record&&record.redirect){return redirect(record,redirectedFrom||location);}if(record&&record.matchAs){return alias(record,location,record.matchAs);}return createRoute(record,location,redirectedFrom);}return{match:match,addRoutes:addRoutes};}function matchRoute(path,params,pathname){var ref=getRouteRegex(path);var regexp=ref.regexp;var keys=ref.keys;var m=pathname.match(regexp);if(!m){return false;}else if(!params){return true;}for(var i=1,len=m.length;i<len;++i){var key=keys[i-1];var val=typeof m[i]==='string'?decodeURIComponent(m[i]):m[i];if(key){params[key.name]=val;}}return true;}function resolveRecordPath(path,record){return resolvePath(path,record.parent?record.parent.path:'/',true);}/*  */var positionStore=Object.create(null);function setupScroll(){window.addEventListener('popstate',function(e){saveScrollPosition();if(e.state&&e.state.key){setStateKey(e.state.key);}});}function handleScroll(router,to,from,isPop){if(!router.app){return;}var behavior=router.options.scrollBehavior;if(!behavior){return;}if(process.env.NODE_ENV!=='production'){assert(typeof behavior==='function',"scrollBehavior must be a function");}// wait until re-render finishes before scrolling
router.app.$nextTick(function(){var position=getScrollPosition();var shouldScroll=behavior(to,from,isPop?position:null);if(!shouldScroll){return;}var isObject=(typeof shouldScroll==='undefined'?'undefined':_typeof(shouldScroll))==='object';if(isObject&&typeof shouldScroll.selector==='string'){var el=document.querySelector(shouldScroll.selector);if(el){position=getElementPosition(el);}else if(isValidPosition(shouldScroll)){position=normalizePosition(shouldScroll);}}else if(isObject&&isValidPosition(shouldScroll)){position=normalizePosition(shouldScroll);}if(position){window.scrollTo(position.x,position.y);}});}function saveScrollPosition(){var key=getStateKey();if(key){positionStore[key]={x:window.pageXOffset,y:window.pageYOffset};}}function getScrollPosition(){var key=getStateKey();if(key){return positionStore[key];}}function getElementPosition(el){var docRect=document.documentElement.getBoundingClientRect();var elRect=el.getBoundingClientRect();return{x:elRect.left-docRect.left,y:elRect.top-docRect.top};}function isValidPosition(obj){return isNumber(obj.x)||isNumber(obj.y);}function normalizePosition(obj){return{x:isNumber(obj.x)?obj.x:window.pageXOffset,y:isNumber(obj.y)?obj.y:window.pageYOffset};}function isNumber(v){return typeof v==='number';}/*  */var supportsPushState=inBrowser&&function(){var ua=window.navigator.userAgent;if((ua.indexOf('Android 2.')!==-1||ua.indexOf('Android 4.0')!==-1)&&ua.indexOf('Mobile Safari')!==-1&&ua.indexOf('Chrome')===-1&&ua.indexOf('Windows Phone')===-1){return false;}return window.history&&'pushState'in window.history;}();// use User Timing api (if present) for more accurate key precision
...
this.current=START;this.pending=null;this.ready=false;this.readyCbs=[];};History.prototype.listen=function listen(cb){this.cb=cb;};History.prototype.onReady=function onReady(cb){if(this.ready){cb();}else{this.readyCbs.push(cb);}};History.prototype.transitionTo=function transitionTo(location,onComplete,onAbort){var this$1=this;var route=this.router.match(location,this.current);this.confirmTransition(route,function(){this$1.updateRoute(route);onComplete&&onComplete(route);this$1.ensureURL();// fire ready cbs once
if(!this$1.ready){this$1.ready=true;this$1.readyCbs.forEach(function(cb){cb(route);});}},onAbort);};History.prototype.confirmTransition=function confirmTransition(route,onComplete,onAbort){var this$1=this;var current=this.current;var abort=function abort(){onAbort&&onAbort();};if(isSameRoute(route,current)&&// in the case the route map has been dynamically appended to
...
next(to);}});};runQueue(queue,iterator,function(){var postEnterCbs=[];var isValid=function isValid(){return this$1.current===route;};var enterGuards=extractEnterGuards(activated,postEnterCbs,isValid);// wait until async components are resolved before
...
def=_Vue.extend(def);}return def.options[key];}function extractLeaveGuards(deactivated){return extractGuards(deactivated,'beforeRouteLeave',bindGuard,true);}function extractUpdateHooks(updated){return extractGuards(updated,'beforeRouteUpdate',bindGuard);}function bindGuard(guard,instance){return function boundRouteGuard(){return guard.apply(instance,arguments);};}function extractEnterGuards(activated,cbs,isValid){return extractGuards(activated,'beforeRouteEnter',function(guard,_,match,key){return bindEnterGuard(guard,match,key,cbs,isValid);});}function bindEnterGuard(guard,match,key,cbs,isValid){return function routeEnterGuard(to,from,next){return guard(to,from,function(cb){next(cb);if(typeof cb==='function'){cbs.push(function(){// #750
...
// resolved.
if(typeof def==='function'&&!def.options){return function(to,from,next){var resolve=once(function(resolvedDef){match.components[key]=resolvedDef;next();});var reject=once(function(reason){warn(false,"Failed to resolve async component "+key+": "+reason);next(false);});var res=def(resolve,reject);if(res&&typeof res.then==='function'){res.then(resolve,reject);}};}});}function flatMapComponents(matched,fn){return flatten(matched.map(function(m){return Object.keys(m.components).map(function(key){return fn(m.components[key],m.instances[key],m,key);});}));}function flatten(arr){return Array.prototype.concat.apply([],arr);}// in Webpack 2, require.ensure now also returns a Promise
// so the resolve/reject functions may get called an extra time
// if the user uses an arrow function shorthand that happens to
// return that Promise.
function once(fn){var called=false;return function(){if(called){return;}called=true;return fn.apply(this,arguments);};}/*  */var HTML5History=function(History$$1){function HTML5History(router,base){var this$1=this;History$$1.call(this,router,base);var expectScroll=router.options.scrollBehavior;if(expectScroll){setupScroll();}window.addEventListener('popstate',function(e){this$1.transitionTo(getLocation(this$1.base),function(route){if(expectScroll){handleScroll(router,route,this$1.current,true);}});});}if(History$$1)HTML5History.__proto__=History$$1;HTML5History.prototype=Object.create(History$$1&&History$$1.prototype);HTML5History.prototype.constructor=HTML5History;HTML5History.prototype.go=function go(n){window.history.go(n);};HTML5History.prototype.push=function push(location,onComplete,onAbort){var this$1=this;this.transitionTo(location,function(route){pushState(cleanPath(this$1.base+route.fullPath));handleScroll(this$1.router,route,this$1.current,false);onComplete&&onComplete(route);},onAbort);};HTML5History.prototype.replace=function replace(location,onComplete,onAbort){var this$1=this;this.transitionTo(location,function(route){replaceState(cleanPath(this$1.base+route.fullPath));handleScroll(this$1.router,route,this$1.current,false);onComplete&&onComplete(route);},onAbort);};HTML5History.prototype.ensureURL=function ensureURL(push){if(getLocation(this.base)!==this.current.fullPath){var current=cleanPath(this.base+this.current.fullPath);push?pushState(current):replaceState(current);}};HTML5History.prototype.getCurrentLocation=function getCurrentLocation(){return getLocation(this.base);};return HTML5History;}(History);function getLocation(base){var path=window.location.pathname;if(base&&path.indexOf(base)===0){path=path.slice(base.length);}return(path||'/')+window.location.search+window.location.hash;}/*  */var HashHistory=function(History$$1){function HashHistory(router,base,fallback){History$$1.call(this,router,base);// check history fallback deeplinking
...
module.exports=g;/***/},/* 15 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_vue_router__=__webpack_require__(12);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_vue_router___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_router__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__components_AdminNav_vue__=__webpack_require__(75);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__components_AdminNav_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_AdminNav_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_2__components_SideMenu_vue__=__webpack_require__(87);/* harmony import */var __WEBPACK_IMPORTED_MODULE_2__components_SideMenu_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_SideMenu_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_3__router_js__=__webpack_require__(50);__webpack_require__(49);Vue.use(__WEBPACK_IMPORTED_MODULE_0_vue_router___default.a);var app=new Vue({el:'#app',router:__WEBPACK_IMPORTED_MODULE_3__router_js__["a"/* default */],components:{sidemenu:__WEBPACK_IMPORTED_MODULE_2__components_SideMenu_vue___default.a,adminnav:__WEBPACK_IMPORTED_MODULE_1__components_AdminNav_vue___default.a}});/***/},/* 16 *//***/function(module,exports){// removed by extract-text-webpack-plugin
/***/},/* 17 *//***/function(module,exports,__webpack_require__){module.exports=__webpack_require__(18);/***/},/* 18 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(3);var bind=__webpack_require__(10);var Axios=__webpack_require__(20);var defaults=__webpack_require__(5);/**
...
axios.Cancel=__webpack_require__(7);axios.CancelToken=__webpack_require__(19);axios.isCancel=__webpack_require__(8);// Expose all/spread
axios.all=function all(promises){return Promise.all(promises);};axios.spread=__webpack_require__(34);module.exports=axios;// Allow use of default import syntax in TypeScript
module.exports.default=axios;/***/},/* 19 *//***/function(module,exports,__webpack_require__){"use strict";var Cancel=__webpack_require__(7);/**
 ...
 */CancelToken.source=function source(){var cancel;var token=new CancelToken(function executor(c){cancel=c;});return{token:token,cancel:cancel};};module.exports=CancelToken;/***/},/* 20 *//***/function(module,exports,__webpack_require__){"use strict";var defaults=__webpack_require__(5);var utils=__webpack_require__(3);var InterceptorManager=__webpack_require__(21);var dispatchRequest=__webpack_require__(22);var isAbsoluteURL=__webpack_require__(30);var combineURLs=__webpack_require__(28);/**
...
utils.forEach(['delete','get','head'],function forEachMethodNoData(method){/*eslint func-names:0*/Axios.prototype[method]=function(url,config){return this.request(utils.merge(config||{},{method:method,url:url}));};});utils.forEach(['post','put','patch'],function forEachMethodWithData(method){/*eslint func-names:0*/Axios.prototype[method]=function(url,data,config){return this.request(utils.merge(config||{},{method:method,url:url,data:data}));};});module.exports=Axios;/***/},/* 21 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(3);function InterceptorManager(){this.handlers=[];}/**
 ...
 */InterceptorManager.prototype.forEach=function forEach(fn){utils.forEach(this.handlers,function forEachHandler(h){if(h!==null){fn(h);}});};module.exports=InterceptorManager;/***/},/* 22 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(3);var transformData=__webpack_require__(25);var isCancel=__webpack_require__(8);var defaults=__webpack_require__(5);/**
 * Throws a `Cancel` if cancellation has been requested.
...
if(reason&&reason.response){reason.response.data=transformData(reason.response.data,reason.response.headers,config.transformResponse);}}return Promise.reject(reason);});};/***/},/* 23 *//***/function(module,exports,__webpack_require__){"use strict";/**
 ...
 */module.exports=function enhanceError(error,config,code,response){error.config=config;if(code){error.code=code;}error.response=response;return error;};/***/},/* 24 *//***/function(module,exports,__webpack_require__){"use strict";var createError=__webpack_require__(9);/**
...
if(!response.status||!validateStatus||validateStatus(response.status)){resolve(response);}else{reject(createError('Request failed with status code '+response.status,response.config,null,response));}};/***/},/* 25 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(3);/**
 ...
 */module.exports=function transformData(data,headers,fns){/*eslint no-param-reassign:0*/utils.forEach(fns,function transform(fn){data=fn(data,headers);});return data;};/***/},/* 26 *//***/function(module,exports,__webpack_require__){"use strict";// btoa polyfill for IE<10 courtesy https://github.com/davidchambers/Base64.js
...
output+=map.charAt(63&block>>8-idx%1*8)){charCode=str.charCodeAt(idx+=3/4);if(charCode>0xFF){throw new E();}block=block<<8|charCode;}return output;}module.exports=btoa;/***/},/* 27 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(3);function encode(val){return encodeURIComponent(val).replace(/%40/gi,'@').replace(/%3A/gi,':').replace(/%24/g,'$').replace(/%2C/gi,',').replace(/%20/g,'+').replace(/%5B/gi,'[').replace(/%5D/gi,']');}/**
 * Build a URL by appending params to the end
 *
 * @param {string} url The base of the url (e.g., http://www.google.com)
 * @param {object} [params] The params to be appended
 * @returns {string} The formatted url
 */module.exports=function buildURL(url,params,paramsSerializer){/*eslint no-param-reassign:0*/if(!params){return url;}var serializedParams;if(paramsSerializer){serializedParams=paramsSerializer(params);}else if(utils.isURLSearchParams(params)){serializedParams=params.toString();}else{var parts=[];utils.forEach(params,function serialize(val,key){if(val===null||typeof val==='undefined'){return;}if(utils.isArray(val)){key=key+'[]';}if(!utils.isArray(val)){val=[val];}utils.forEach(val,function parseValue(v){if(utils.isDate(v)){v=v.toISOString();}else if(utils.isObject(v)){v=JSON.stringify(v);}parts.push(encode(key)+'='+encode(v));});});serializedParams=parts.join('&');}if(serializedParams){url+=(url.indexOf('?')===-1?'?':'&')+serializedParams;}return url;};/***/},/* 28 *//***/function(module,exports,__webpack_require__){"use strict";/**
 * Creates a new URL by combining the specified URLs
 *
 * @param {string} baseURL The base URL
 * @param {string} relativeURL The relative URL
 * @returns {string} The combined URL
 */module.exports=function combineURLs(baseURL,relativeURL){return baseURL.replace(/\/+$/,'')+'/'+relativeURL.replace(/^\/+/,'');};/***/},/* 29 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(3);module.exports=utils.isStandardBrowserEnv()?// Standard browser envs support document.cookie
...
function nonStandardBrowserEnv(){return{write:function write(){},read:function read(){return null;},remove:function remove(){}};}();/***/},/* 30 *//***/function(module,exports,__webpack_require__){"use strict";/**
...
return /^([a-z][a-z\d\+\-\.]*:)?\/\//i.test(url);};/***/},/* 31 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(3);module.exports=utils.isStandardBrowserEnv()?// Standard browser envs have full support of the APIs needed to test
...
function nonStandardBrowserEnv(){return function isURLSameOrigin(){return true;};}();/***/},/* 32 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(3);module.exports=function normalizeHeaderName(headers,normalizedName){utils.forEach(headers,function processHeader(value,name){if(name!==normalizedName&&name.toUpperCase()===normalizedName.toUpperCase()){headers[normalizedName]=value;delete headers[name];}});};/***/},/* 33 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(3);/**
 ...
 */module.exports=function parseHeaders(headers){var parsed={};var key;var val;var i;if(!headers){return parsed;}utils.forEach(headers.split('\n'),function parser(line){i=line.indexOf(':');key=utils.trim(line.substr(0,i)).toLowerCase();val=utils.trim(line.substr(i+1));if(key){parsed[key]=parsed[key]?parsed[key]+', '+val:val;}});return parsed;};/***/},/* 34 *//***/function(module,exports,__webpack_require__){"use strict";/**
 ...
 * @returns {Function}
 */module.exports=function spread(callback){return function wrap(arr){return callback.apply(null,arr);};};/***/},/* 35 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',data:function data(){return{};},computed:{},methods:{},mounted:function mounted(){},created:function created(){}};/***/},/* 36 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',data:function data(){return{};},computed:{},methods:{},mounted:function mounted(){},created:function created(){}};/***/},/* 37 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__NavigatePanel_vue__=__webpack_require__(85);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__NavigatePanel_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__NavigatePanel_vue__);//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',components:{navpanel:__WEBPACK_IMPORTED_MODULE_0__NavigatePanel_vue___default.a},data:function data(){return{listDesc:false,newUser:{firstname:"",surname:"",position:"",email:""}};},computed:{},methods:{save:function save(){return;}},mounted:function mounted(){},created:function created(){}};/***/},/* 38 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__LoadingSpinner_vue__=__webpack_require__(84);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__LoadingSpinner_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__LoadingSpinner_vue__);//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',components:{spinner:__WEBPACK_IMPORTED_MODULE_0__LoadingSpinner_vue___default.a},data:function data(){return{user:{id:null,firstname:"",surname:"",email:"",position:['a']},listDesc:false};},computed:{isLoading:function isLoading(){return!this.user.id;}},methods:{save:function save(){return;}},mounted:function mounted(){},created:function created(){}};/***/},/* 39 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__PlayerFilter_vue__=__webpack_require__(86);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__PlayerFilter_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__PlayerFilter_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__Event_js__=__webpack_require__(11);//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',components:{playerfilter:__WEBPACK_IMPORTED_MODULE_0__PlayerFilter_vue___default.a},data:function data(){return{users:[{id:1,firstname:"d",surname:"r",email:"a"}],showOptions:{id:true,fullname:true,firstname:false,surname:false,email:false},listDesc:false};},computed:{},methods:{fullName:function fullName(u){return u.firstname+" "+u.surname;}},mounted:function mounted(){},created:function created(){}};/***/},/* 40 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',data:function data(){return{};},computed:{},methods:{},mounted:function mounted(){},created:function created(){}};/***/},/* 41 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',data:function data(){return{};},computed:{},methods:{},mounted:function mounted(){},created:function created(){}};/***/},/* 42 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',data:function data(){return{};},computed:{},methods:{},mounted:function mounted(){},created:function created(){}};/***/},/* 43 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',data:function data(){return{};},computed:{},methods:{},mounted:function mounted(){},created:function created(){}};/***/},/* 44 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',data:function data(){return{};},computed:{},methods:{},mounted:function mounted(){},created:function created(){}};/***/},/* 45 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',props:['message'],data:function data(){return{};},computed:{},methods:{},mounted:function mounted(){},created:function created(){}};/***/},/* 46 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',props:['to','toTitle','toIcon','from','fromTitle','fromIcon'],data:function data(){return{};},computed:{back:function back(){return this.to?this.to:'/admin';},next:function next(){return this.from?this.from:'/admin';}},methods:{},mounted:function mounted(){console.log(this.$router);},created:function created(){}};/***/},/* 47 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__Event_js__=__webpack_require__(11);//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',data:function data(){return{open:false};},computed:{},methods:{},mounted:function mounted(){},created:function created(){}};/***/},/* 48 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'',data:function data(){return{};},computed:{},methods:{isActive:function isActive(p){return this.$route.path==p;}},mounted:function mounted(){},created:function created(){}};/***/},/* 49 *//***/function(module,exports,__webpack_require__){window._=__webpack_require__(73);/**
 ...
 */window.axios=__webpack_require__(17);window.axios.defaults.headers.common={'X-CSRF-TOKEN':document.getElementsByName('_token')[0].value,'X-Requested-With':'XMLHttpRequest'};/**
...
//     key: 'your-pusher-key'
// });
/***/},/* 50 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_vue_router__=__webpack_require__(12);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_vue_router___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_router__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__components_AdminDashboard_vue__=__webpack_require__(74);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__components_AdminDashboard_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_AdminDashboard_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_2__components_Admin_Players_AdminPlayers_vue__=__webpack_require__(79);/* harmony import */var __WEBPACK_IMPORTED_MODULE_2__components_Admin_Players_AdminPlayers_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_Admin_Players_AdminPlayers_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_3__components_Admin_Players_AdminPlayerList_vue__=__webpack_require__(78);/* harmony import */var __WEBPACK_IMPORTED_MODULE_3__components_Admin_Players_AdminPlayerList_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_Admin_Players_AdminPlayerList_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_4__components_Admin_Players_AdminPlayerCreate_vue__=__webpack_require__(76);/* harmony import */var __WEBPACK_IMPORTED_MODULE_4__components_Admin_Players_AdminPlayerCreate_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_Admin_Players_AdminPlayerCreate_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_5__components_Admin_Players_AdminPlayerEdit_vue__=__webpack_require__(77);/* harmony import */var __WEBPACK_IMPORTED_MODULE_5__components_Admin_Players_AdminPlayerEdit_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__components_Admin_Players_AdminPlayerEdit_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_6__components_Admin_Unis_AdminUniversities_vue__=__webpack_require__(83);/* harmony import */var __WEBPACK_IMPORTED_MODULE_6__components_Admin_Unis_AdminUniversities_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_Admin_Unis_AdminUniversities_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_7__components_Admin_Unis_AdminUniList_vue__=__webpack_require__(82);/* harmony import */var __WEBPACK_IMPORTED_MODULE_7__components_Admin_Unis_AdminUniList_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__components_Admin_Unis_AdminUniList_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_8__components_Admin_Unis_AdminUniCreate_vue__=__webpack_require__(80);/* harmony import */var __WEBPACK_IMPORTED_MODULE_8__components_Admin_Unis_AdminUniCreate_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__components_Admin_Unis_AdminUniCreate_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_9__components_Admin_Unis_AdminUniEdit_vue__=__webpack_require__(81);/* harmony import */var __WEBPACK_IMPORTED_MODULE_9__components_Admin_Unis_AdminUniEdit_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__components_Admin_Unis_AdminUniEdit_vue__);var router=new __WEBPACK_IMPORTED_MODULE_0_vue_router___default.a({mode:'history',routes:[{path:'/admin',component:__WEBPACK_IMPORTED_MODULE_1__components_AdminDashboard_vue___default.a},{path:'/admin/players',component:__WEBPACK_IMPORTED_MODULE_2__components_Admin_Players_AdminPlayers_vue___default.a,children:[{path:"",component:__WEBPACK_IMPORTED_MODULE_3__components_Admin_Players_AdminPlayerList_vue___default.a},{path:"create",component:__WEBPACK_IMPORTED_MODULE_4__components_Admin_Players_AdminPlayerCreate_vue___default.a,name:'createPlayer'},{path:"edit",component:__WEBPACK_IMPORTED_MODULE_5__components_Admin_Players_AdminPlayerEdit_vue___default.a,name:'editPlayer'}]},{path:'/admin/universities',component:__WEBPACK_IMPORTED_MODULE_6__components_Admin_Unis_AdminUniversities_vue___default.a,children:[{path:"",component:__WEBPACK_IMPORTED_MODULE_7__components_Admin_Unis_AdminUniList_vue___default.a},{path:"create",component:__WEBPACK_IMPORTED_MODULE_8__components_Admin_Unis_AdminUniCreate_vue___default.a,name:'createUni'},{path:"edit",component:__WEBPACK_IMPORTED_MODULE_9__components_Admin_Unis_AdminUniEdit_vue___default.a,name:'editUni'}]},{path:'/admin/notifications',component:__WEBPACK_IMPORTED_MODULE_1__components_AdminDashboard_vue___default.a}]});/* harmony default export */__webpack_exports__["a"]=router;/***/},/* 51 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 52 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 53 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 54 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 55 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 56 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 57 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 58 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 59 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 60 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 61 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 62 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 63 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 64 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(0)();// imports
// module
exports.push([module.i,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",""]);// exports
/***/},/* 65 *//***/function(module,exports){module.exports="/images/ring.gif?83ce53a1466dfc526a11ea020d94272d";/***/},/* 66 *//***/function(module,exports){module.exports="/images/logo.png?9d1191f0173c26de661bee51800b7400";/***/},/* 67 *//***/function(module,exports){module.exports="/images/user.png?9005a38967a0095089c15ea50d3462d3";/***/},/* 68 *//***/function(module,exports){module.exports="/images/user1.png?692a4a0ac355f48fce1cf6132f3a3104";/***/},/* 69 *//***/function(module,exports){module.exports="/images/user2.png?9db90ad4c4e058bc639c9be1b7219463";/***/},/* 70 *//***/function(module,exports){module.exports="/images/user3.png?0f8ab8b94c3d8630255f0bcf201740f0";/***/},/* 71 *//***/function(module,exports){module.exports="/images/user4.png?756744638fc121ca1766b4294d323107";/***/},/* 72 *//***/function(module,exports){module.exports="/images/user5.png?9721a7756ae70b938c546f73f7fef6e9";/***/},/* 73 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global,module){var __WEBPACK_AMD_DEFINE_RESULT__;/**
 * @license
...
root._=_;}}).call(this);/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(14),__webpack_require__(117)(module));/***/},/* 74 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(112);var Component=__webpack_require__(1)(/* script */__webpack_require__(35),/* template */__webpack_require__(98),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\AdminDashboard.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminDashboard.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-8c62a5ce",Component.options);}else{hotAPI.reload("data-v-8c62a5ce",Component.options);}})();}module.exports=Component.exports;/***/},/* 75 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(114);var Component=__webpack_require__(1)(/* script */__webpack_require__(36),/* template */__webpack_require__(100),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\AdminNav.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminNav.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-b7827c30",Component.options);}else{hotAPI.reload("data-v-b7827c30",Component.options);}})();}module.exports=Component.exports;/***/},/* 76 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(105);var Component=__webpack_require__(1)(/* script */__webpack_require__(37),/* template */__webpack_require__(91),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\Admin\\Players\\AdminPlayerCreate.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminPlayerCreate.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-282cd7ab",Component.options);}else{hotAPI.reload("data-v-282cd7ab",Component.options);}})();}module.exports=Component.exports;/***/},/* 77 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(106);var Component=__webpack_require__(1)(/* script */__webpack_require__(38),/* template */__webpack_require__(92),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\Admin\\Players\\AdminPlayerEdit.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminPlayerEdit.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-2e5d0779",Component.options);}else{hotAPI.reload("data-v-2e5d0779",Component.options);}})();}module.exports=Component.exports;/***/},/* 78 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(103);var Component=__webpack_require__(1)(/* script */__webpack_require__(39),/* template */__webpack_require__(89),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\Admin\\Players\\AdminPlayerList.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminPlayerList.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-1f14e00d",Component.options);}else{hotAPI.reload("data-v-1f14e00d",Component.options);}})();}module.exports=Component.exports;/***/},/* 79 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(111);var Component=__webpack_require__(1)(/* script */__webpack_require__(40),/* template */__webpack_require__(97),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\Admin\\Players\\AdminPlayers.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminPlayers.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-8700c598",Component.options);}else{hotAPI.reload("data-v-8700c598",Component.options);}})();}module.exports=Component.exports;/***/},/* 80 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(113);var Component=__webpack_require__(1)(/* script */__webpack_require__(41),/* template */__webpack_require__(99),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\Admin\\Unis\\AdminUniCreate.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminUniCreate.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-a8fc7336",Component.options);}else{hotAPI.reload("data-v-a8fc7336",Component.options);}})();}module.exports=Component.exports;/***/},/* 81 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(107);var Component=__webpack_require__(1)(/* script */__webpack_require__(42),/* template */__webpack_require__(93),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\Admin\\Unis\\AdminUniEdit.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminUniEdit.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-31b25cb3",Component.options);}else{hotAPI.reload("data-v-31b25cb3",Component.options);}})();}module.exports=Component.exports;/***/},/* 82 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(104);var Component=__webpack_require__(1)(/* script */__webpack_require__(43),/* template */__webpack_require__(90),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\Admin\\Unis\\AdminUniList.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminUniList.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-226a3547",Component.options);}else{hotAPI.reload("data-v-226a3547",Component.options);}})();}module.exports=Component.exports;/***/},/* 83 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(102);var Component=__webpack_require__(1)(/* script */__webpack_require__(44),/* template */__webpack_require__(88),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\Admin\\Unis\\AdminUniversities.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] AdminUniversities.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-1b050ce3",Component.options);}else{hotAPI.reload("data-v-1b050ce3",Component.options);}})();}module.exports=Component.exports;/***/},/* 84 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(110);var Component=__webpack_require__(1)(/* script */__webpack_require__(45),/* template */__webpack_require__(96),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\LoadingSpinner.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] LoadingSpinner.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-7b8ece51",Component.options);}else{hotAPI.reload("data-v-7b8ece51",Component.options);}})();}module.exports=Component.exports;/***/},/* 85 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(109);var Component=__webpack_require__(1)(/* script */__webpack_require__(46),/* template */__webpack_require__(95),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\NavigatePanel.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] NavigatePanel.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-72657faf",Component.options);}else{hotAPI.reload("data-v-72657faf",Component.options);}})();}module.exports=Component.exports;/***/},/* 86 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(108);var Component=__webpack_require__(1)(/* script */__webpack_require__(47),/* template */__webpack_require__(94),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\PlayerFilter.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] PlayerFilter.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-5ddc57cd",Component.options);}else{hotAPI.reload("data-v-5ddc57cd",Component.options);}})();}module.exports=Component.exports;/***/},/* 87 *//***/function(module,exports,__webpack_require__){/* styles */__webpack_require__(115);var Component=__webpack_require__(1)(/* script */__webpack_require__(48),/* template */__webpack_require__(101),/* scopeId */null,/* cssModules */null);Component.options.__file='C:\\Users\\david\\Code\\academy\\resources\\assets\\js\\components\\SideMenu.vue';if(Component.esModule&&Object.keys(Component.esModule).some(function(key){return key!=="default"&&key!=="__esModule";})){console.error("named exports are not supported in *.vue files.");}if(Component.options.functional){console.error("[vue-loader] SideMenu.vue: functional components are not supported with templates, they should use render functions.");}/* hot reload */if(false){(function(){var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),false);if(!hotAPI.compatible)return;module.hot.accept();if(!module.hot.data){hotAPI.createRecord("data-v-bb52c62c",Component.options);}else{hotAPI.reload("data-v-bb52c62c",Component.options);}})();}module.exports=Component.exports;/***/},/* 88 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"panel"},[_c('router-view'),_vm._v(" "),_c('router-link',{attrs:{"to":{name:'createUni'}}},[_vm._v("create")]),_vm._v(" "),_c('router-link',{attrs:{"to":{name:'editUni'}}},[_vm._v("edit")])],1);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-1b050ce3",module.exports);}}/***/},/* 89 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"panel panel-headline"},[_c('div',{staticClass:"text-right"},[_c('router-link',{staticClass:"btn btn-default",attrs:{"to":{name:'createPlayer'}}},[_vm._v("Add a player")])],1),_vm._v(" "),_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("Players list "),_c('i',{staticClass:"fa fa-question-circle-o",on:{"click":function click($event){_vm.listDesc=!_vm.listDesc;}}})]),_vm._v(" "),_vm.listDesc?_c('p',{staticClass:"panel-subtitle"},[_vm._v("\n            Below is a list of all players registered. You can change the display and filter through the players\n            with the filter system. Alongside the players details are buttons for editing and deleting players.\n        ")]):_vm._e()]),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('playerfilter'),_vm._v(" "),_c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"table table-hover"},[_c('thead',[_c('tr',[_vm.showOptions.id?_c('th',[_vm._v("ID")]):_vm._e(),_vm._v(" "),_vm.showOptions.fullname?_c('th',[_vm._v("Name")]):_vm._e(),_vm._v(" "),_vm.showOptions.firstname?_c('th',[_vm._v("Firstname")]):_vm._e(),_vm._v(" "),_vm.showOptions.surname?_c('th',[_vm._v("Surname")]):_vm._e(),_vm._v(" "),_vm.showOptions.email?_c('th',[_vm._v("Email")]):_vm._e(),_vm._v(" "),_c('th')])]),_vm._v(" "),_c('tbody',_vm._l(_vm.users,function(user,index){return _c('tr',[_vm.showOptions.id?_c('td',[_vm._v(_vm._s(user.id))]):_vm._e(),_vm._v(" "),_vm.showOptions.fullname?_c('td',[_vm._v(_vm._s(_vm.fullName(user)))]):_vm._e(),_vm._v(" "),_vm.showOptions.firstname?_c('td',[_vm._v(_vm._s(user.firstname))]):_vm._e(),_vm._v(" "),_vm.showOptions.surname?_c('td',[_vm._v(_vm._s(user.surname))]):_vm._e(),_vm._v(" "),_vm.showOptions.email?_c('td',[_vm._v(_vm._s(user.email))]):_vm._e(),_vm._v(" "),_c('td')]);}))])])],1)]);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-1f14e00d",module.exports);}}/***/},/* 90 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._v("\n    list\n")]);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-226a3547",module.exports);}}/***/},/* 91 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"panel panel-headline"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("Creating a new player "),_c('i',{staticClass:"fa fa-question-circle-o",on:{"click":function click($event){_vm.listDesc=!_vm.listDesc;}}})]),_vm._v(" "),_vm.listDesc?_c('p',{staticClass:"panel-subtitle"},[_vm._v("\n                Complete the profile to your and click save; simple!\n            ")]):_vm._e()]),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('div',{staticClass:"row metric"},[_c('div',{staticClass:"col-xs-12 col-md-6"},[_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"form-label",attrs:{"for":"firstname"}},[_vm._v("Firstname:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.newUser.firstname,expression:"newUser.firstname"}],staticClass:"form-control",attrs:{"type":"text","id":"firstname"},domProps:{"value":_vm._s(_vm.newUser.firstname)},on:{"input":function input($event){if($event.target.composing){return;}_vm.newUser.firstname=$event.target.value;}}})])]),_vm._v(" "),_c('div',{staticClass:"col-xs-12 col-md-6"},[_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"form-label",attrs:{"for":"surname"}},[_vm._v("Surname:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.newUser.surname,expression:"newUser.surname"}],staticClass:"form-control",attrs:{"type":"text","id":"surname"},domProps:{"value":_vm._s(_vm.newUser.surname)},on:{"input":function input($event){if($event.target.composing){return;}_vm.newUser.surname=$event.target.value;}}})])]),_vm._v(" "),_c('div',{staticClass:"col-xs-12 col-md-6"},[_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"form-label",attrs:{"for":"email"}},[_vm._v("Email address:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.newUser.email,expression:"newUser.email"}],staticClass:"form-control",attrs:{"type":"text","id":"email"},domProps:{"value":_vm._s(_vm.newUser.email)},on:{"input":function input($event){if($event.target.composing){return;}_vm.newUser.email=$event.target.value;}}})])]),_vm._v(" "),_c('div',{staticClass:"col-xs-12 col-md-6"},[_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"form-label",attrs:{"for":"position"}},[_vm._v("Position:")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:_vm.newUser.position,expression:"newUser.position"}],staticClass:"form-control",attrs:{"id":"position"},on:{"change":function change($event){_vm.newUser.position=Array.prototype.filter.call($event.target.options,function(o){return o.selected;}).map(function(o){var val="_value"in o?o._value:o.value;return val;})[0];}}},[_c('option',{attrs:{"value":"a"}},[_vm._v("a")])])])]),_vm._v(" "),_c('div',{staticClass:"col-xs-12 text-center"},[_c('div',{staticClass:"form-group"},[_c('button',{staticClass:"btn btn-primary",on:{"click":_vm.save}},[_vm._v("Save")])])])])])])]);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-282cd7ab",module.exports);}}/***/},/* 92 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('transition',{attrs:{"name":"fade","mode":"out-in"}},[_vm.isLoading?_c('spinner',{attrs:{"message":"Loading"}}):_c('div',{staticClass:"panel panel-headline"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("Creating a new player "),_c('i',{staticClass:"fa fa-question-circle-o",on:{"click":function click($event){_vm.listDesc=!_vm.listDesc;}}})]),_vm._v(" "),_c('transition',{attrs:{"name":"fade"}},[_vm.listDesc?_c('p',{staticClass:"panel-subtitle"},[_vm._v("\n                        Complete the profile to your and click save; simple!\n                    ")]):_vm._e()])],1),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('div',{staticClass:"row metric"},[_c('div',{staticClass:"col-xs-12 col-md-6"},[_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"form-label",attrs:{"for":"firstname"}},[_vm._v("Firstname:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.user.firstname,expression:"user.firstname"}],staticClass:"form-control",attrs:{"type":"text","id":"firstname"},domProps:{"value":_vm._s(_vm.user.firstname)},on:{"input":function input($event){if($event.target.composing){return;}_vm.user.firstname=$event.target.value;}}})])]),_vm._v(" "),_c('div',{staticClass:"col-xs-12 col-md-6"},[_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"form-label",attrs:{"for":"surname"}},[_vm._v("Surname:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.user.surname,expression:"user.surname"}],staticClass:"form-control",attrs:{"type":"text","id":"surname"},domProps:{"value":_vm._s(_vm.user.surname)},on:{"input":function input($event){if($event.target.composing){return;}_vm.user.surname=$event.target.value;}}})])]),_vm._v(" "),_c('div',{staticClass:"col-xs-12 col-md-6"},[_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"form-label",attrs:{"for":"email"}},[_vm._v("Email address:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.user.email,expression:"user.email"}],staticClass:"form-control",attrs:{"type":"text","id":"email"},domProps:{"value":_vm._s(_vm.user.email)},on:{"input":function input($event){if($event.target.composing){return;}_vm.user.email=$event.target.value;}}})])]),_vm._v(" "),_c('div',{staticClass:"col-xs-12 col-md-6"},[_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"form-label",attrs:{"for":"position"}},[_vm._v("Position:")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:_vm.user.position,expression:"user.position"}],staticClass:"form-control",attrs:{"id":"position"},on:{"change":function change($event){_vm.user.position=Array.prototype.filter.call($event.target.options,function(o){return o.selected;}).map(function(o){var val="_value"in o?o._value:o.value;return val;})[0];}}},[_c('option',{attrs:{"value":"a"}},[_vm._v("a")])])])]),_vm._v(" "),_c('div',{staticClass:"col-xs-12 text-center"},[_c('div',{staticClass:"form-group"},[_c('button',{staticClass:"btn btn-primary",on:{"click":_vm.save}},[_vm._v("Save")])])])])])])],1)],1);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-2e5d0779",module.exports);}}/***/},/* 93 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._v("\n    edit\n")]);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-31b25cb3",module.exports);}}/***/},/* 94 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"row"},[_c('div',{staticClass:"col-xs-12"},[!_vm.open?_c('i',{staticClass:"fa fa-arrow-right",on:{"click":function click($event){_vm.open=!_vm.open;}}}):_vm._e(),_vm._v(" "),_vm.open?_c('i',{staticClass:"fa fa-arrow-down",on:{"click":function click($event){_vm.open=!_vm.open;}}}):_vm._e(),_vm._v(" "),_c('h4',{staticStyle:{"display":"inline"}},[_vm._v("Search and Filter")])])]);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-5ddc57cd",module.exports);}}/***/},/* 95 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"panel panel-headline"},[_vm.from?_c('router-link',{staticClass:"pull-left",attrs:{"to":_vm.back}},[_vm._v("Back forward")]):_vm._e(),_vm._v(" "),_c('span',{staticClass:"pull-left",on:{"click":_vm.goBack}},[_vm._v("Back")]),_vm._v(" "),_c('router-link',{staticClass:"pull-right",attrs:{"to":_vm.next}},[_vm._v("dkhb")]),_vm._v(" "),_c('span',{staticClass:"pull-left",on:{"click":_vm.goForwar}},[_vm._v("Forward")])],1);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-72657faf",module.exports);}}/***/},/* 96 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"panel panel-headliner"},[_c('div',{staticClass:"text-center"},[_c('img',{attrs:{"src":__webpack_require__(65)}}),_vm._v(" "),_c('h3',[_vm._v(_vm._s(_vm.message)+"…")])])]);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-7b8ece51",module.exports);}}/***/},/* 97 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('transition',{attrs:{"name":"slideRight","mode":"out-in"}},[_c('router-view')],1)],1);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-8700c598",module.exports);}}/***/},/* 98 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _vm._m(0);},staticRenderFns:[function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"panel panel-headline"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("Weekly Overview")]),_vm._v(" "),_c('p',{staticClass:"panel-subtitle"},[_vm._v("Period: Oct 14, 2016 - Oct 21, 2016")])]),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-3"},[_c('div',{staticClass:"metric"},[_c('span',{staticClass:"icon"},[_c('i',{staticClass:"fa fa-download"})]),_vm._v(" "),_c('p',[_c('span',{staticClass:"number"},[_vm._v("1,252")]),_vm._v(" "),_c('span',{staticClass:"title"},[_vm._v("Downloads")])])])]),_vm._v(" "),_c('div',{staticClass:"col-md-3"},[_c('div',{staticClass:"metric"},[_c('span',{staticClass:"icon"},[_c('i',{staticClass:"fa fa-shopping-bag"})]),_vm._v(" "),_c('p',[_c('span',{staticClass:"number"},[_vm._v("203")]),_vm._v(" "),_c('span',{staticClass:"title"},[_vm._v("Sales")])])])]),_vm._v(" "),_c('div',{staticClass:"col-md-3"},[_c('div',{staticClass:"metric"},[_c('span',{staticClass:"icon"},[_c('i',{staticClass:"fa fa-eye"})]),_vm._v(" "),_c('p',[_c('span',{staticClass:"number"},[_vm._v("274,678")]),_vm._v(" "),_c('span',{staticClass:"title"},[_vm._v("Visits")])])])]),_vm._v(" "),_c('div',{staticClass:"col-md-3"},[_c('div',{staticClass:"metric"},[_c('span',{staticClass:"icon"},[_c('i',{staticClass:"fa fa-bar-chart"})]),_vm._v(" "),_c('p',[_c('span',{staticClass:"number"},[_vm._v("35%")]),_vm._v(" "),_c('span',{staticClass:"title"},[_vm._v("Conversions")])])])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-9"},[_c('div',{staticClass:"ct-chart",attrs:{"id":"headline-chart"}})]),_vm._v(" "),_c('div',{staticClass:"col-md-3"},[_c('div',{staticClass:"weekly-summary text-right"},[_c('span',{staticClass:"number"},[_vm._v("2,315")]),_vm._v(" "),_c('span',{staticClass:"percentage"},[_c('i',{staticClass:"fa fa-caret-up text-success"}),_vm._v(" 12%")]),_vm._v(" "),_c('span',{staticClass:"info-label"},[_vm._v("Total Sales")])]),_vm._v(" "),_c('div',{staticClass:"weekly-summary text-right"},[_c('span',{staticClass:"number"},[_vm._v("$5,758")]),_vm._v(" "),_c('span',{staticClass:"percentage"},[_c('i',{staticClass:"fa fa-caret-up text-success"}),_vm._v(" 23%")]),_vm._v(" "),_c('span',{staticClass:"info-label"},[_vm._v("Monthly Income")])]),_vm._v(" "),_c('div',{staticClass:"weekly-summary text-right"},[_c('span',{staticClass:"number"},[_vm._v("$65,938")]),_vm._v(" "),_c('span',{staticClass:"percentage"},[_c('i',{staticClass:"fa fa-caret-down text-danger"}),_vm._v(" 8%")]),_vm._v(" "),_c('span',{staticClass:"info-label"},[_vm._v("Total Income")])])])])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-6"},[_c('div',{staticClass:"panel"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("Recent Purchases")]),_vm._v(" "),_c('div',{staticClass:"right"},[_c('button',{staticClass:"btn-toggle-collapse",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-chevron-up"})]),_vm._v(" "),_c('button',{staticClass:"btn-remove",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-cross"})])])]),_vm._v(" "),_c('div',{staticClass:"panel-body no-padding"},[_c('table',{staticClass:"table table-striped"},[_c('thead',[_c('tr',[_c('th',[_vm._v("Order No.")]),_vm._v(" "),_c('th',[_vm._v("Name")]),_vm._v(" "),_c('th',[_vm._v("Amount")]),_vm._v(" "),_c('th',[_vm._v("Date & Time")]),_vm._v(" "),_c('th',[_vm._v("Status")])])]),_vm._v(" "),_c('tbody',[_c('tr',[_c('td',[_c('a',{attrs:{"href":"#"}},[_vm._v("763648")])]),_vm._v(" "),_c('td',[_vm._v("Steve")]),_vm._v(" "),_c('td',[_vm._v("$122")]),_vm._v(" "),_c('td',[_vm._v("Oct 21, 2016")]),_vm._v(" "),_c('td',[_c('span',{staticClass:"label label-success"},[_vm._v("COMPLETED")])])]),_vm._v(" "),_c('tr',[_c('td',[_c('a',{attrs:{"href":"#"}},[_vm._v("763649")])]),_vm._v(" "),_c('td',[_vm._v("Amber")]),_vm._v(" "),_c('td',[_vm._v("$62")]),_vm._v(" "),_c('td',[_vm._v("Oct 21, 2016")]),_vm._v(" "),_c('td',[_c('span',{staticClass:"label label-warning"},[_vm._v("PENDING")])])]),_vm._v(" "),_c('tr',[_c('td',[_c('a',{attrs:{"href":"#"}},[_vm._v("763650")])]),_vm._v(" "),_c('td',[_vm._v("Michael")]),_vm._v(" "),_c('td',[_vm._v("$34")]),_vm._v(" "),_c('td',[_vm._v("Oct 18, 2016")]),_vm._v(" "),_c('td',[_c('span',{staticClass:"label label-danger"},[_vm._v("FAILED")])])]),_vm._v(" "),_c('tr',[_c('td',[_c('a',{attrs:{"href":"#"}},[_vm._v("763651")])]),_vm._v(" "),_c('td',[_vm._v("Roger")]),_vm._v(" "),_c('td',[_vm._v("$186")]),_vm._v(" "),_c('td',[_vm._v("Oct 17, 2016")]),_vm._v(" "),_c('td',[_c('span',{staticClass:"label label-success"},[_vm._v("SUCCESS")])])]),_vm._v(" "),_c('tr',[_c('td',[_c('a',{attrs:{"href":"#"}},[_vm._v("763652")])]),_vm._v(" "),_c('td',[_vm._v("Smith")]),_vm._v(" "),_c('td',[_vm._v("$362")]),_vm._v(" "),_c('td',[_vm._v("Oct 16, 2016")]),_vm._v(" "),_c('td',[_c('span',{staticClass:"label label-success"},[_vm._v("SUCCESS")])])])])])]),_vm._v(" "),_c('div',{staticClass:"panel-footer"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-6"},[_c('span',{staticClass:"panel-note"},[_c('i',{staticClass:"fa fa-clock-o"}),_vm._v(" Last 24 hours")])]),_vm._v(" "),_c('div',{staticClass:"col-md-6 text-right"},[_c('a',{staticClass:"btn btn-primary",attrs:{"href":"#"}},[_vm._v("View All Purchases")])])])])])]),_vm._v(" "),_c('div',{staticClass:"col-md-6"},[_c('div',{staticClass:"panel"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("Projection vs. Realization")]),_vm._v(" "),_c('div',{staticClass:"right"},[_c('button',{staticClass:"btn-toggle-collapse",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-chevron-up"})]),_vm._v(" "),_c('button',{staticClass:"btn-remove",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-cross"})])])]),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('div',{staticClass:"ct-chart",attrs:{"id":"visits-trends-chart"}})])])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-7"},[_c('div',{staticClass:"panel"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("To-Do List")]),_vm._v(" "),_c('div',{staticClass:"right"},[_c('button',{staticClass:"btn-toggle-collapse",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-chevron-up"})]),_vm._v(" "),_c('button',{staticClass:"btn-remove",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-cross"})])])]),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('ul',{staticClass:"list-unstyled todo-list"},[_c('li',[_c('label',{staticClass:"control-inline fancy-checkbox"},[_c('input',{attrs:{"type":"checkbox"}}),_c('span')]),_vm._v(" "),_c('p',[_c('span',{staticClass:"title"},[_vm._v("Restart Server")]),_vm._v(" "),_c('span',{staticClass:"short-description"},[_vm._v("Dynamically integrate client-centric technologies without cooperative resources.")]),_vm._v(" "),_c('span',{staticClass:"date"},[_vm._v("Oct 9, 2016")])]),_vm._v(" "),_c('div',{staticClass:"controls"},[_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"icon-software icon-software-pencil"})]),_vm._v(" "),_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"icon-arrows icon-arrows-circle-remove"})])])]),_vm._v(" "),_c('li',[_c('label',{staticClass:"control-inline fancy-checkbox"},[_c('input',{attrs:{"type":"checkbox"}}),_c('span')]),_vm._v(" "),_c('p',[_c('span',{staticClass:"title"},[_vm._v("Retest Upload Scenario")]),_vm._v(" "),_c('span',{staticClass:"short-description"},[_vm._v("Compellingly implement clicks-and-mortar relationships without highly efficient metrics.")]),_vm._v(" "),_c('span',{staticClass:"date"},[_vm._v("Oct 23, 2016")])]),_vm._v(" "),_c('div',{staticClass:"controls"},[_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"icon-software icon-software-pencil"})]),_vm._v(" "),_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"icon-arrows icon-arrows-circle-remove"})])])]),_vm._v(" "),_c('li',[_c('label',{staticClass:"control-inline fancy-checkbox"},[_c('input',{attrs:{"type":"checkbox"}}),_c('span')]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Functional Spec Meeting")]),_vm._v(" "),_c('span',{staticClass:"short-description"},[_vm._v("Monotonectally formulate client-focused core competencies after parallel web-readiness.")]),_vm._v(" "),_c('span',{staticClass:"date"},[_vm._v("Oct 11, 2016")])]),_vm._v(" "),_c('div',{staticClass:"controls"},[_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"icon-software icon-software-pencil"})]),_vm._v(" "),_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"icon-arrows icon-arrows-circle-remove"})])])])])])])]),_vm._v(" "),_c('div',{staticClass:"col-md-5"},[_c('div',{staticClass:"panel panel-scrolling"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("Recent User Activity")]),_vm._v(" "),_c('div',{staticClass:"right"},[_c('button',{staticClass:"btn-toggle-collapse",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-chevron-up"})]),_vm._v(" "),_c('button',{staticClass:"btn-remove",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-cross"})])])]),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('ul',{staticClass:"list-unstyled activity-list"},[_c('li',[_c('img',{staticClass:"img-circle pull-left avatar",attrs:{"src":__webpack_require__(68),"alt":"Avatar"}}),_vm._v(" "),_c('p',[_c('a',{attrs:{"href":"#"}},[_vm._v("Michael")]),_vm._v(" has achieved 80% of his completed tasks "),_c('span',{staticClass:"timestamp"},[_vm._v("20 minutes ago")])])]),_vm._v(" "),_c('li',[_c('img',{staticClass:"img-circle pull-left avatar",attrs:{"src":__webpack_require__(69),"alt":"Avatar"}}),_vm._v(" "),_c('p',[_c('a',{attrs:{"href":"#"}},[_vm._v("Daniel")]),_vm._v(" has been added as a team member to project "),_c('a',{attrs:{"href":"#"}},[_vm._v("System Update")]),_vm._v(" "),_c('span',{staticClass:"timestamp"},[_vm._v("Yesterday")])])]),_vm._v(" "),_c('li',[_c('img',{staticClass:"img-circle pull-left avatar",attrs:{"src":__webpack_require__(70),"alt":"Avatar"}}),_vm._v(" "),_c('p',[_c('a',{attrs:{"href":"#"}},[_vm._v("Martha")]),_vm._v(" created a new heatmap view "),_c('a',{attrs:{"href":"#"}},[_vm._v("Landing Page")]),_vm._v(" "),_c('span',{staticClass:"timestamp"},[_vm._v("2 days ago")])])]),_vm._v(" "),_c('li',[_c('img',{staticClass:"img-circle pull-left avatar",attrs:{"src":__webpack_require__(71),"alt":"Avatar"}}),_vm._v(" "),_c('p',[_c('a',{attrs:{"href":"#"}},[_vm._v("Jane")]),_vm._v(" has completed all of the tasks "),_c('span',{staticClass:"timestamp"},[_vm._v("2 days ago")])])]),_vm._v(" "),_c('li',[_c('img',{staticClass:"img-circle pull-left avatar",attrs:{"src":__webpack_require__(72),"alt":"Avatar"}}),_vm._v(" "),_c('p',[_c('a',{attrs:{"href":"#"}},[_vm._v("Jason")]),_vm._v(" started a discussion about "),_c('a',{attrs:{"href":"#"}},[_vm._v("Weekly Meeting")]),_vm._v(" "),_c('span',{staticClass:"timestamp"},[_vm._v("3 days ago")])])])]),_vm._v(" "),_c('button',{staticClass:"btn btn-primary btn-bottom center-block",attrs:{"type":"button"}},[_vm._v("Load More")])])])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-4"},[_c('div',{staticClass:"panel"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("My Tasks")]),_vm._v(" "),_c('div',{staticClass:"right"},[_c('button',{staticClass:"btn-toggle-collapse",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-chevron-up"})]),_vm._v(" "),_c('button',{staticClass:"btn-remove",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-cross"})])])]),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('ul',{staticClass:"list-unstyled task-list"},[_c('li',[_c('p',[_vm._v("Updating Users Settings "),_c('span',{staticClass:"label-percent"},[_vm._v("23%")])]),_vm._v(" "),_c('div',{staticClass:"progress progress-xs"},[_c('div',{staticClass:"progress-bar progress-bar-danger",staticStyle:{"width":"23%"},attrs:{"role":"progressbar","aria-valuenow":"23","aria-valuemin":"0","aria-valuemax":"100"}},[_c('span',{staticClass:"sr-only"},[_vm._v("23% Complete")])])])]),_vm._v(" "),_c('li',[_c('p',[_vm._v("Load & Stress Test "),_c('span',{staticClass:"label-percent"},[_vm._v("80%")])]),_vm._v(" "),_c('div',{staticClass:"progress progress-xs"},[_c('div',{staticClass:"progress-bar progress-bar-success",staticStyle:{"width":"80%"},attrs:{"role":"progressbar","aria-valuenow":"80","aria-valuemin":"0","aria-valuemax":"100"}},[_c('span',{staticClass:"sr-only"},[_vm._v("80% Complete")])])])]),_vm._v(" "),_c('li',[_c('p',[_vm._v("Data Duplication Check "),_c('span',{staticClass:"label-percent"},[_vm._v("100%")])]),_vm._v(" "),_c('div',{staticClass:"progress progress-xs"},[_c('div',{staticClass:"progress-bar progress-bar-success",staticStyle:{"width":"100%"},attrs:{"role":"progressbar","aria-valuenow":"100","aria-valuemin":"0","aria-valuemax":"100"}},[_c('span',{staticClass:"sr-only"},[_vm._v("Success")])])])]),_vm._v(" "),_c('li',[_c('p',[_vm._v("Server Check "),_c('span',{staticClass:"label-percent"},[_vm._v("45%")])]),_vm._v(" "),_c('div',{staticClass:"progress progress-xs"},[_c('div',{staticClass:"progress-bar progress-bar-warning",staticStyle:{"width":"45%"},attrs:{"role":"progressbar","aria-valuenow":"45","aria-valuemin":"0","aria-valuemax":"100"}},[_c('span',{staticClass:"sr-only"},[_vm._v("45% Complete")])])])]),_vm._v(" "),_c('li',[_c('p',[_vm._v("Mobile App Development "),_c('span',{staticClass:"label-percent"},[_vm._v("10%")])]),_vm._v(" "),_c('div',{staticClass:"progress progress-xs"},[_c('div',{staticClass:"progress-bar progress-bar-danger",staticStyle:{"width":"10%"},attrs:{"role":"progressbar","aria-valuenow":"10","aria-valuemin":"0","aria-valuemax":"100"}},[_c('span',{staticClass:"sr-only"},[_vm._v("10% Complete")])])])])])])])]),_vm._v(" "),_c('div',{staticClass:"col-md-4"},[_c('div',{staticClass:"panel"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("Website Visits")]),_vm._v(" "),_c('div',{staticClass:"right"},[_c('button',{staticClass:"btn-toggle-collapse",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-chevron-up"})]),_vm._v(" "),_c('button',{staticClass:"btn-remove",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-cross"})])])]),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('div',{staticClass:"ct-chart",attrs:{"id":"visits-chart"}})])])]),_vm._v(" "),_c('div',{staticClass:"col-md-4"},[_c('div',{staticClass:"panel"},[_c('div',{staticClass:"panel-heading"},[_c('h3',{staticClass:"panel-title"},[_vm._v("System Load")]),_vm._v(" "),_c('div',{staticClass:"right"},[_c('button',{staticClass:"btn-toggle-collapse",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-chevron-up"})]),_vm._v(" "),_c('button',{staticClass:"btn-remove",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-cross"})])])]),_vm._v(" "),_c('div',{staticClass:"panel-body"},[_c('div',{staticClass:"easy-pie-chart",attrs:{"id":"system-load","data-percent":"70"}},[_c('span',{staticClass:"percent"},[_vm._v("70")])]),_vm._v(" "),_c('h4',[_vm._v("CPU Load")]),_vm._v(" "),_c('ul',{staticClass:"list-unstyled list-justify"},[_c('li',[_vm._v("High: "),_c('span',[_vm._v("95%")])]),_vm._v(" "),_c('li',[_vm._v("Average: "),_c('span',[_vm._v("87%")])]),_vm._v(" "),_c('li',[_vm._v("Low: "),_c('span',[_vm._v("20%")])]),_vm._v(" "),_c('li',[_vm._v("Threads: "),_c('span',[_vm._v("996")])]),_vm._v(" "),_c('li',[_vm._v("Processes: "),_c('span',[_vm._v("259")])])])])])])])]);}]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-8c62a5ce",module.exports);}}/***/},/* 99 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._v("\n    create\n")]);},staticRenderFns:[]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-a8fc7336",module.exports);}}/***/},/* 100 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _vm._m(0);},staticRenderFns:[function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nav',{staticClass:"navbar navbar-default"},[_c('div',{staticClass:"container-fluid"},[_c('div',{staticClass:"navbar-btn"},[_c('button',{staticClass:"btn-toggle-fullwidth",attrs:{"type":"button"}},[_c('i',{staticClass:"lnr lnr-arrow-left-circle"})])]),_vm._v(" "),_c('div',{staticClass:"navbar-header"},[_c('button',{staticClass:"navbar-toggle collapsed",attrs:{"type":"button","data-toggle":"collapse","data-target":"#navbar-menu"}},[_c('span',{staticClass:"sr-only"},[_vm._v("Toggle Navigation")]),_vm._v(" "),_c('i',{staticClass:"fa fa-bars icon-nav"})])]),_vm._v(" "),_c('div',{staticClass:"navbar-collapse collapse",attrs:{"id":"navbar-menu"}},[_c('form',{staticClass:"navbar-form navbar-left hidden-xs"},[_c('div',{staticClass:"input-group"},[_c('input',{staticClass:"form-control",attrs:{"type":"text","value":"","placeholder":"Search dashboard..."}}),_vm._v(" "),_c('span',{staticClass:"input-group-btn"},[_c('button',{staticClass:"btn btn-primary",attrs:{"type":"button"}},[_vm._v("Go")])])])]),_vm._v(" "),_c('ul',{staticClass:"nav navbar-nav navbar-right"},[_c('li',{staticClass:"dropdown"},[_c('a',{staticClass:"dropdown-toggle icon-menu",attrs:{"href":"#","data-toggle":"dropdown"}},[_c('i',{staticClass:"lnr lnr-alarm"}),_vm._v(" "),_c('span',{staticClass:"badge bg-danger"},[_vm._v("5")])]),_vm._v(" "),_c('ul',{staticClass:"dropdown-menu notifications"},[_c('li',[_c('a',{staticClass:"notification-item",attrs:{"href":"#"}},[_c('span',{staticClass:"dot bg-warning"}),_vm._v("System space is almost full")])]),_vm._v(" "),_c('li',[_c('a',{staticClass:"notification-item",attrs:{"href":"#"}},[_c('span',{staticClass:"dot bg-danger"}),_vm._v("You have 9 unfinished tasks")])]),_vm._v(" "),_c('li',[_c('a',{staticClass:"notification-item",attrs:{"href":"#"}},[_c('span',{staticClass:"dot bg-success"}),_vm._v("Monthly report is available")])]),_vm._v(" "),_c('li',[_c('a',{staticClass:"notification-item",attrs:{"href":"#"}},[_c('span',{staticClass:"dot bg-warning"}),_vm._v("Weekly meeting in 1 hour")])]),_vm._v(" "),_c('li',[_c('a',{staticClass:"notification-item",attrs:{"href":"#"}},[_c('span',{staticClass:"dot bg-success"}),_vm._v("Your request has been approved")])]),_vm._v(" "),_c('li',[_c('a',{staticClass:"more",attrs:{"href":"#"}},[_vm._v("See all notifications")])])])]),_vm._v(" "),_c('li',{staticClass:"dropdown"},[_c('a',{staticClass:"dropdown-toggle",attrs:{"href":"#","data-toggle":"dropdown"}},[_c('i',{staticClass:"lnr lnr-question-circle"}),_vm._v(" "),_c('span',[_vm._v("Help")]),_vm._v(" "),_c('i',{staticClass:"icon-submenu lnr lnr-chevron-down"})]),_vm._v(" "),_c('ul',{staticClass:"dropdown-menu"},[_c('li',[_c('a',{attrs:{"href":"#"}},[_vm._v("Basic Use")])]),_vm._v(" "),_c('li',[_c('a',{attrs:{"href":"#"}},[_vm._v("Working With Data")])]),_vm._v(" "),_c('li',[_c('a',{attrs:{"href":"#"}},[_vm._v("Security")])]),_vm._v(" "),_c('li',[_c('a',{attrs:{"href":"#"}},[_vm._v("Troubleshooting")])])])]),_vm._v(" "),_c('li',{staticClass:"dropdown"},[_c('a',{staticClass:"dropdown-toggle",attrs:{"href":"#","data-toggle":"dropdown"}},[_c('img',{staticClass:"img-circle",attrs:{"src":__webpack_require__(67),"alt":"Avatar"}}),_vm._v(" "),_c('span',[_vm._v("Samuel")]),_vm._v(" "),_c('i',{staticClass:"icon-submenu lnr lnr-chevron-down"})]),_vm._v(" "),_c('ul',{staticClass:"dropdown-menu"},[_c('li',[_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"lnr lnr-user"}),_vm._v(" "),_c('span',[_vm._v("My Profile")])])]),_vm._v(" "),_c('li',[_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"lnr lnr-envelope"}),_vm._v(" "),_c('span',[_vm._v("Message")])])]),_vm._v(" "),_c('li',[_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"lnr lnr-cog"}),_vm._v(" "),_c('span',[_vm._v("Settings")])])]),_vm._v(" "),_c('li',[_c('a',{attrs:{"href":"#"}},[_c('i',{staticClass:"lnr lnr-exit"}),_vm._v(" "),_c('span',[_vm._v("Logout")])])])])])])])])]);}]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-b7827c30",module.exports);}}/***/},/* 101 *//***/function(module,exports,__webpack_require__){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"sidebar"},[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"sidebar-scroll"},[_c('nav',[_c('ul',{staticClass:"nav"},[_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin')},attrs:{"to":"/admin"}},[_c('i',{staticClass:"lnr lnr-home"}),_vm._v(" "),_c('span',[_vm._v("Dashboard")])])],1),_vm._v(" "),_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/players')},attrs:{"to":"/admin/players"}},[_c('i',{staticClass:"lnr lnr-code"}),_vm._v(" "),_c('span',[_vm._v("Players")])])],1),_vm._v(" "),_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/universities')},attrs:{"to":"/admin/universities"}},[_c('i',{staticClass:"lnr lnr-chart-bars"}),_vm._v(" "),_c('span',[_vm._v("Universities")])])],1),_vm._v(" "),_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/positions')},attrs:{"to":"/admin/positions"}},[_c('i',{staticClass:"lnr lnr-cog"}),_vm._v(" "),_c('span',[_vm._v("Positions")])])],1),_vm._v(" "),_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/notifications')},attrs:{"to":"/admin/notifications"}},[_c('i',{staticClass:"lnr lnr-alarm"}),_vm._v(" "),_c('span',[_vm._v("Notifications")])])],1),_vm._v(" "),_c('li',[_vm._m(1),_vm._v(" "),_c('div',{staticClass:"collapse ",attrs:{"id":"subPages"}},[_c('ul',{staticClass:"nav"},[_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/pages/1')},attrs:{"to":"/admin/pages/1"}},[_vm._v("Home")])],1),_vm._v(" "),_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/pages/2')},attrs:{"to":"/admin/pages/2"}},[_vm._v("About us")])],1),_vm._v(" "),_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/pages/3')},attrs:{"to":"/admin/pages/3"}},[_vm._v("Contact us")])],1)])])]),_vm._v(" "),_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/categories')},attrs:{"to":"/admin/categories"}},[_c('i',{staticClass:"lnr lnr-dice"}),_vm._v(" "),_c('span',[_vm._v("Categories")])])],1),_vm._v(" "),_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/characteristics')},attrs:{"to":"/admin/characteristics"}},[_c('i',{staticClass:"lnr lnr-text-format"}),_vm._v(" "),_c('span',[_vm._v("Characteristics")])])],1),_vm._v(" "),_c('li',[_c('router-link',{class:{active:_vm.isActive('/admin/blogs')},attrs:{"to":"/admin/blogs"}},[_c('i',{staticClass:"lnr lnr-text-format"}),_vm._v(" "),_c('span',[_vm._v("Blogs")])])],1)])])])]);},staticRenderFns:[function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"brand"},[_c('a',{attrs:{"href":"index.html"}},[_c('img',{staticClass:"img-responsive logo",attrs:{"src":__webpack_require__(66),"alt":"Klorofil Logo"}})])]);},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('a',{staticClass:"collapsed",attrs:{"href":"#subPages","data-toggle":"collapse"}},[_c('i',{staticClass:"lnr lnr-file-empty"}),_vm._v(" "),_c('span',[_vm._v("Pages")]),_vm._v(" "),_c('i',{staticClass:"icon-submenu lnr lnr-chevron-left"})]);}]};module.exports.render._withStripped=true;if(false){module.hot.accept();if(module.hot.data){require("vue-hot-reload-api").rerender("data-v-bb52c62c",module.exports);}}/***/},/* 102 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
var content=__webpack_require__(51);if(typeof content==='string')content=[[module.i,content,'']];if(content.locals)module.exports=content.locals;// add the styles to the DOM
var update=__webpack_require__(2)("59e9d719",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1b050ce3!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminUniversities.vue",function(){var newContent=require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1b050ce3!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminUniversities.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 103 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
...
var update=__webpack_require__(2)("956f13b4",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1f14e00d!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminPlayerList.vue",function(){var newContent=require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1f14e00d!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminPlayerList.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 104 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
var content=__webpack_require__(53);if(typeof content==='string')content=[[module.i,content,'']];if(content.locals)module.exports=content.locals;// add the styles to the DOM
var update=__webpack_require__(2)("28081a4c",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-226a3547!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminUniList.vue",function(){var newContent=require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-226a3547!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminUniList.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 105 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
...
var update=__webpack_require__(2)("6bba3198",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-282cd7ab!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminPlayerCreate.vue",function(){var newContent=require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-282cd7ab!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminPlayerCreate.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 106 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
...
var update=__webpack_require__(2)("72a9edb4",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2e5d0779!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminPlayerEdit.vue",function(){var newContent=require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2e5d0779!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminPlayerEdit.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 107 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
var content=__webpack_require__(56);if(typeof content==='string')content=[[module.i,content,'']];if(content.locals)module.exports=content.locals;// add the styles to the DOM
var update=__webpack_require__(2)("2cbdb8eb",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-31b25cb3!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminUniEdit.vue",function(){var newContent=require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-31b25cb3!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminUniEdit.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 108 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
...
var update=__webpack_require__(2)("698eccbe",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-5ddc57cd!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PlayerFilter.vue",function(){var newContent=require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-5ddc57cd!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PlayerFilter.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 109 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
var content=__webpack_require__(58);if(typeof content==='string')content=[[module.i,content,'']];if(content.locals)module.exports=content.locals;// add the styles to the DOM
var update=__webpack_require__(2)("5ad8c70a",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-72657faf!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NavigatePanel.vue",function(){var newContent=require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-72657faf!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NavigatePanel.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 110 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
...
var update=__webpack_require__(2)("e58dce7c",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-7b8ece51!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./LoadingSpinner.vue",function(){var newContent=require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-7b8ece51!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./LoadingSpinner.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 111 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
var content=__webpack_require__(60);if(typeof content==='string')content=[[module.i,content,'']];if(content.locals)module.exports=content.locals;// add the styles to the DOM
var update=__webpack_require__(2)("41a1d9d6",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8700c598!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminPlayers.vue",function(){var newContent=require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8700c598!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminPlayers.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 112 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
...
var update=__webpack_require__(2)("a5eaf47e",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8c62a5ce!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminDashboard.vue",function(){var newContent=require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8c62a5ce!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminDashboard.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 113 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
var content=__webpack_require__(62);if(typeof content==='string')content=[[module.i,content,'']];if(content.locals)module.exports=content.locals;// add the styles to the DOM
var update=__webpack_require__(2)("0c0b7942",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-a8fc7336!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminUniCreate.vue",function(){var newContent=require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-a8fc7336!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminUniCreate.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 114 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
var content=__webpack_require__(63);if(typeof content==='string')content=[[module.i,content,'']];if(content.locals)module.exports=content.locals;// add the styles to the DOM
var update=__webpack_require__(2)("4c4af18d",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-b7827c30!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminNav.vue",function(){var newContent=require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-b7827c30!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdminNav.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 115 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
...
var update=__webpack_require__(2)("c106b558",content,false);// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-bb52c62c!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SideMenu.vue",function(){var newContent=require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-bb52c62c!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SideMenu.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 116 *//***/function(module,exports){/**
 * Translates the list format produced by css-loader into something
 * easier to manipulate.
 */module.exports=function listToStyles(parentId,list){var styles=[];var newStyles={};for(var i=0;i<list.length;i++){var item=list[i];var id=item[0];var css=item[1];var media=item[2];var sourceMap=item[3];var part={id:parentId+':'+i,css:css,media:media,sourceMap:sourceMap};if(!newStyles[id]){styles.push(newStyles[id]={id:id,parts:[part]});}else{newStyles[id].parts.push(part);}}return styles;};/***/},/* 117 *//***/function(module,exports){module.exports=function(module){if(!module.webpackPolyfill){module.deprecate=function(){};module.paths=[];// module.parent = undefined by default
if(!module.children)module.children=[];Object.defineProperty(module,"loaded",{enumerable:true,get:function get(){return module.l;}});Object.defineProperty(module,"id",{enumerable:true,get:function get(){return module.i;}});module.webpackPolyfill=1;}return module;};/***/},/* 118 *//***/function(module,exports,__webpack_require__){__webpack_require__(15);module.exports=__webpack_require__(16);/***/}]);
